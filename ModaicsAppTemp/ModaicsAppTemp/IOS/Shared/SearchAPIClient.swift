...
// Types (SearchRequest, SearchResult, SearchResponse, AIAnalysisResult, AIDescriptionResult, SearchAPIError)
// are defined in APIModels.swift to avoid duplication
